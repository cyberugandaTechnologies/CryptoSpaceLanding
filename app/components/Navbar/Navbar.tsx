...
const Navbar = () => {
    ...
    return (
        <Disclosure as="nav" className="navbar w-full">
            <>
    ...
    <a href="https://crypto-project-space.vercel.app" className="text-xl font-semibold py-3 px-4 md:py-4 md:px-6 navbutton text-white">
        Sign In
    </a>
    <button className="text-xl font-semibold py-3 px-4 md:py-4 md:px-6 navbutton text-white">
        Connect Wallet
    </button>
</div>
                            {/* <Contactusform /> */}
